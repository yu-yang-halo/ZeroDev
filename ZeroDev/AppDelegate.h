...
typedef NS_ENUM(NSUInteger,ROOT_VIEWCONTROLLER_TYPE){
    ...
    ROOT_VIEWCONTROLLER_TYPE_REGISTER_DEVICE,
    ROOT_VIEWCONTROLLER_TYPE_REGISTER_VIDEO,
    ROOT_VIEWCONTROLLER_TYPE_DELETE_DEVICE,
    ROOT_VIEWCONTROLLER_TYPE_WIFI_CONFIG,
};
